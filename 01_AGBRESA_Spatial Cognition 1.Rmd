...
#library(openxlsx) # save tableone as xls; source ("./Software/R/tableone_helper_functions.R") 
library(readxl) # read xls

#library(Rmisc) # for descriptives and plots if summary is used, describe by
#library(Hmisc)
...
#library(data.table) # Print table nicely in markdown
...
#colnames(df_sut)[4] <- "c_rt"
#colnames(df_sut)[5] <- "b_precision"
#colnames(df_sut)[6] <- "a_direction"
#colnames(df_sut)[7] <- "a_speed_z"
#colnames(df_sut)[8] <- "b_precision_z"
#colnames(df_sut)[9] <- "d_direction_z"
#colnames(df_sut)[10] <- "c_eff_z"

# PTO
df_pto <- read_excel("./Data/Data Spatial Cognition 1.xlsx",
                     sheet = "Data PTO z")
df_pto[c(1:3)] <- lapply(df_pto[c(1:3)], as.factor)
#colnames(df_pto)[4] <- "d_rating"
#colnames(df_pto)[5] <- "e_rt"
#colnames(df_pto)[6] <- "b_distance_error"
#colnames(df_pto)[7] <- "c_precision"
#colnames(df_pto)[8] <- "a_direction"
#colnames(df_pto)[13] <- "a_speed_z"
#colnames(df_pto)[14] <- "b_precision_z"
#colnames(df_pto)[15] <- "f_direction_z"
#colnames(df_pto)[16] <- "d_distance_error_z"
#colnames(df_pto)[17] <- "e_rating_z"
#colnames(df_pto)[18] <- "c_eff_z"
...
#colnames(df_4mtn)[3] <- "accuracy"
#colnames(df_4mtn)[4] <- "rt"
#colnames(df_4mtn)[5] <- "b_accuracy_z"
#colnames(df_4mtn)[6] <- "a_speed_z"
#colnames(df_4mtn)[7] <- "c_eff_z"
#df_4mtn <- df_4mtn[c(1:4,6,5,7)]
...
#colnames(df_navis_2d)[4] <- "completion_time"
#colnames(df_navis_2d)[7] <- "distance"
#colnames(df_navis_2d)[10] <- "revisits"
#colnames(df_navis_2d)[11] <- "b_accuracy_z"
#colnames(df_navis_2d)[12] <- "a_speed_z"
#colnames(df_navis_2d)[14] <- "c_distance_z"
#colnames(df_navis_2d)[13] <- "f_time_to_first_revisit_z"
#colnames(df_navis_2d)[17] <- "d_total_revisits_z"
#colnames(df_navis_2d)[16] <- "e_total_target_visits_z"
#df_navis_2d <- df_navis_2d[c(1:3,12,11,14,17,16,13)]
```
