---
title: "Appendix Final Report HyperCampus Grand Means Cognitive Performance"
#author: "A Stahn"
#date: "10/27/2021"
#output:
...
func_bdc_correction_cognition <- function(data, ...) {
...
```
```{r tab.cap = "Mixed Model Summary for Spatial Cognition Battery 1.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_spacog_1 <- tbl_mm_fac_aov_df_spacog_1 %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_spacog_1
```
...
```
```{r tab.cap = "Mixed Model Group Contrasts for Spatial Cognition Battery 1.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_df_spacog_1 <- tbl_contr_emm_fac_df_spacog_1 %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_df_spacog_1
```
...
```
```{r tab.cap = "Mixed Model Summary testing the Main Effect of Group for Spatial Cognition Battery 1.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_spacog_1_main <- tbl_mm_fac_aov_df_spacog_1_main %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_spacog_1_main
```
...
```
```{r tab.cap = "Mixed Model Contrasts Comparing Groups for Spatial Cognition Battery 1.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_spacog_1_main <- tbl_contr_emm_fac_spacog_1_main %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_spacog_1_main
```
...
dev.off()
```
```{r fig.id = "tsplot", fig.cap.style = "Image Caption", fig.width = 5, fig.height = 6.5, echo = FALSE, fig.cap = "Spatial Cognition Battery 1: (a) Time course of speed, precision, and efficiency before, during, and after bed rest. (b) Main effect of bed rest. Data are means and SD adjusted for baseline."}
p.spacog_1_comb
```
...
```
```{r tab.cap = "Mixed Model Summary for Spatial Cognition Battery 2.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_spacog_2 <- tbl_mm_fac_aov_df_spacog_2 %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_spacog_2
```
...
```
```{r tab.cap = "Mixed Model Group Contrasts for Spatial Cognition Battery 2.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_df_spaccog_2 <- tbl_contr_emm_fac_df_spaccog_2 %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_df_spaccog_2
```
...
dev.off()
```
```{r fig.id = "tsplot", fig.cap.style = "Image Caption", fig.width = 3, fig.height = 2.5, echo = FALSE, fig.cap = "Spatial Cognition Battery 2: Effects of Bed Rest on Speed, Accuracy, and Efficiency after Bed Rest. Data are means and SE."}
p.spacog_2_emmeans
```
# Executive Control
##Overall score
...
```
```{r tab.cap = "Mixed Model Summary for Executive Control Tasks.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_exe_ctrl <- tbl_mm_fac_aov_df_exe_ctrl %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_exe_ctrl
```
##Contrasts for Group Comparisons
...
```
```{r tab.cap = "Mixed Model Group Contrasts for Executive Control Tasks.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_df_exe_ctrl <- tbl_contr_emm_fac_df_exe_ctrl %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_df_exe_ctrl
```
##Plot Estimated Marignal Means for Group Comparisons
...
dev.off()
```
```{r fig.id = "tsplot", fig.cap.style = "Image Caption", fig.width = 3, fig.height = 2.5, echo = FALSE, fig.cap = " Executive Control Tasks: Effects of Bed Rest on Speed, Accuracy, and Efficiency after Bed Rest. Data are means and SE."}
p.exe_ctrl_emmeans
```
# Cognition
##Overall score
...
# Shift mean within groups to reflect a pre-HDT baseline performance of 0 (zero) (To reflect the analytical approach (adjusting for baseline performance).
desc <- func_bdc_correction_cognition(desc)
...
```
```{r tab.cap = "Mixed Model Summary for Cognition Battery.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_cognition <- tbl_mm_fac_aov_df_cognition %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_cognition
```
##Contrasts for Comparing Groups at Each Time Point During Bed Rest
...
```
```{r tab.cap = "Mixed Model Group Contrasts for Cognition Battery.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_df_cognition <- tbl_contr_emm_fac_df_cognition %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_df_cognition
```
##Plot Estimated Marignal Means To Show Time Course for Each Group
...
```
```{r tab.cap = "Mixed Model Summary testing the Main Effect of Group for Cognition Battery.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_mm_fac_aov_df_cognition_main <- tbl_mm_fac_aov_df_cognition_main %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df2", "F"), digits = 1) %>% 
  colformat_double( j = c("P"), digits = 3 ) 
# Print
tbl_mm_fac_aov_df_cognition_main
```
##Contrasts for Comparing Groups
...
```
```{r tab.cap = "Mixed Model Contrasts Comparing Groups for Cognition Battery.", tab.topcaption = TRUE, echo = FALSE}
# Convert to word flextable
tbl_contr_emm_fac_cognition_main <- tbl_contr_emm_fac_cognition_main %>% flextable() %>% autofit() %>% 
  colformat_double( j = c("df", "t"), digits = 1) %>% 
  colformat_double( j = c("P (unadjusted)"), digits = 3 ) 
# Print
tbl_contr_emm_fac_cognition_main
```
##Plot Estimated Marignal Means for Comparing Groups
...
dev.off()
```
```{r fig.id = "tsplot", fig.cap.style = "Image Caption", fig.width = 7, fig.height = 5, echo = FALSE, fig.cap = "Cognition Battery 1: (a) Time course of speed, precision, and efficiency before, during, and after bed rest. (b) Main effect of bed rest. Data are means and SD adjusted for baseline, age, and sex."}
p.cognition_comb_all
```