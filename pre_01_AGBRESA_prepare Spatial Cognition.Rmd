...
func_z <- function(x) {
  ...
  tmp <- reshape2::dcast(tmp, id_vars_dep)
  return(tmp)
}
```
...
df_pto <- df_pto[c(2,5:6,8,38,40,42,53,58:69)]
...
# convert data types
df_pto[c(1:2,4,13:20)] <- lapply(df_pto[c(1:2,4,13:20)], as.factor)
df_pto[c(3,5:12)] <- lapply(df_pto[c(3,5:12)], as.numeric)
...
df_pto <- ddply(df_pto, c("spatial_cognition_id", "time.f","cond.f"), summarise,
                    rating=mean(rating),
                    rt=mean(rt),
...
# convert data types
df_navstrat[c(1:4)] <- lapply(df_navstrat[c(1:4)], factor)
...
df_demo <- read_excel("/Users/astahn/Publications/AGBRESA/Data/Data All.xlsx", sheet = "Data Demo")
...
df_cogmap[c(1:4)] <- lapply(df_cogmap[c(1:4)], factor)
...
# convert data types
df_dualtask[c(1:5)] <- lapply(df_dualtask[c(1:5)], factor)
...
list_of_datasets <- list( "Data SUT" = df_sut,
                          ...
                          "Data SUT z score" = df_sut_z,
                          "Data PTO z score" = df_pto_z,
                          "Data 4MTN z score" = df_4mtn_z,
                          "Data NAVIS 2D z score" = df_navis_2d_z,
                          "Data NAVIS VR z score" = df_navis_vr_z)
...
list_of_datasets <- list( "Data SOT" = df_sot,
                          ...
                          "Data SOT z score" = df_sot_z,
                          "Data WM z score" = df_wm_z,
                          "Data PM z score" = df_pm_z,
                          "Data Navstrat z score" = df_navstrat_z,
                          "Data Cognitive Mapping z score" = df_cogmap_z)
...
list_of_datasets <- list( "Data Dual" = df_dualtask,
                          ...
                          "Data Dual z score" = df_dualtask_z,
                          "Data Switch z score" = df_switch_z)
